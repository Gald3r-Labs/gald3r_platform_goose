...
This project runs on **[Gald3r](https://github.com/wrm3/gald3r) for Goose** -- file-based
...
Open this project in **Goose** and run **`@g-setup`** -- it initializes gald3r and fills in
